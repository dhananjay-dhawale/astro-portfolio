export default function Hero() {
  return (
    <section
      className="min-h-screen flex flex-col justify-center items-center text-center px-4 bg-gradient-to-b from-black via-slate-900 to-black"
      id="hero"
    >
      <div className="bg-white/10 backdrop-blur-md p-10 rounded-2xl shadow-xl max-w-2xl w-full border border-white/10">
